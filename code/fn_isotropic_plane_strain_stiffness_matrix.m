function stiffness_matrix = fn_isotropic_plane_strain_stiffness_matrix(youngs_modulus, poissons_ratio)
%SUMMARY
%   Returns 3 x 3 plane strain stiffness matrix for isotropic material
...
stiffness_matrix = youngs_modulus / (1 + poissons_ratio) / (1 - 2 * poissons_ratio) * ...
