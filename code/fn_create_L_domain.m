function dom = fn_create_domain(mod, inner_bdry, abs_layer_thick, varargin)
...
[~, cand_els] = fn_elements_in_region(dom.mod.nds, dom.mod.els, abs_layer_start_bdry);
...
[~, out] = fn_elements_in_region(nds, els(layer_els,:), nds(bdry_nds, :));
