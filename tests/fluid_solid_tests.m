...
src_angle_degs = 15; %0 is normal incidence
src_len = 4e-3;
...
src_end_pts = src_rad * [sind(src_angle_degs), -cosd(src_angle_degs)] + [-1;1] * [cosd(src_angle_degs), sind(src_angle_degs)] * src_len / 2;
...
%Monitoring points at mirror position in water
mon_end_pts1 = src_rad * [-sind(src_angle_degs), -cosd(src_angle_degs)] + [-1;1] * [-cosd(src_angle_degs), sind(src_angle_degs)] * src_len / 2;
steps{1}.mon.nds = fn_find_nodes_on_line(mod.nds, mon_end_pts1(1, :), mon_end_pts1(2, :), el_size / 2);
