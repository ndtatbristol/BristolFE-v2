...
%Transducer
el_size = trans_size / no_els;
el_cents = linspace(-0.5, 0.5, no_els)' * (trans_size - el_size) * [cosd(trans_angd), sind(trans_angd)] + trans_cent;
for e = 1:no_els
