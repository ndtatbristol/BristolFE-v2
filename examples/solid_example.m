...
src_dir = 2; %direction of forces applied: 1 = x, 2 = y, 3 = z
...
mod = fn_rectangular_structured_mesh(bdry_pts, el_size)
...
mod.el_typ_i = repmat({'CPE3'},[n_els, 1]);
